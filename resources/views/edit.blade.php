            ...
            <form action="{{ route('mobil.update', $mobil->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="harga_jual" name="harga_jual" value="{{ $mobil->harga_jual }}" required>
                    </div>

                    <div class="col-md-6">
                        <label for="harga_beli" class="form-label">Harga Beli (Rp)</label>
                        <input type="number" class="form-control" id="harga_beli" name="harga_beli" value="{{ $mobil->harga_beli }}" required>
                    </div>
