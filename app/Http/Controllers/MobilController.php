...
class MobilController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $path = $request->file('foto_mobil')->store('mobil-photos');
        ...
        Mobil::create([
            ...
            'harga_beli' => $validatedData['harga_jual'], 
        ...
        return back()->with('success', 'Data mobil baru berhasil ditambahkan!');
    }
    ...
    public function update(Request $request, Mobil $mobil)
    {
        ...
        if ($request->hasFile('foto_mobil_baru')) {
            Storage::delete($mobil->foto_mobil);
            $updateData['foto_mobil'] = $request->file('foto_mobil_baru')->store('mobil-photos');
        } else {
